...
class BERT4Rec(SequentialRecommender):
    ...
    def forward(self, item_seq):
        ...
        position_ids = position_ids.unsqueeze(0).expand_as(item_seq)#[0,2,.....maxlen-1]

        item_emb = self.item_embedding(item_seq)#[2048, 20, 512])
    ...
    def calculate_loss(self, interaction):
        ...
        if self.loss_type == "BPR":
            ...
            #test_item_emb = self.item_embedding.embedding.weight[: self.n_items]  # [item_num H]
